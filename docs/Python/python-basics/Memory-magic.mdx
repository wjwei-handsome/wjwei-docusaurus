...
<ReferenceList
  data={[
    {
      title: "simulating-pointers-in-python",
      link: "https://realpython.com/pointers-in-python/#simulating-pointers-in-python",
      src: python,
    },
    {
      title: "identifying-reference-cycles",
      link: "https://devguide.python.org/internals/garbage-collector/index.html#identifying-reference-cycles",
      src: python,
    },
  ]}
/>
